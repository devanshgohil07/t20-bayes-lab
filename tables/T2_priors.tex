...
$\sigma^2$ & $\mathrm{IG}(3, 52,000)$ & Prior mean 26,000, from the ball-by-ball run distribution: $\mathrm{Var}(X)=2.80$ runs per ball $\Rightarrow \sigma^2\approx27,978$. \\[2pt]
\bottomrule
\end{tabular}